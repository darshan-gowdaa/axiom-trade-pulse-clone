...
export function TokenColumnSkeleton({ className }: TokenColumnSkeletonProps) {
    return (
        <div className={`w-full flex flex-col h-full min-h-0 bg-[#101114] border-r border-[#1d1f26] ${className || ''}`}>
            <div className="hidden lg:flex items-center justify-between px-2 py-1.5 border-b border-[#1d1f26] bg-[#101114] sticky top-0 z-10 mb-0.5 animate-shimmer-container">
            ...
            <div className="flex-1 overflow-hidden shimmer-column">
