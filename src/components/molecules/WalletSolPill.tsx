...
const VARIANT_STYLES: Record<WalletPillVariant, {
    ...
    default: {
        ...
        walletIcon: 'w-3.5 h-3.5 text-[#d4d4d8]',
        text: 'text-white text-[11px] font-medium',
        solanaSize: { width: 9, height: 9 },
        arrowIcon: 'w-3.5 h-3.5 text-[#6b6b7a]',
    },
    compact: {
        ...
        walletIcon: 'w-3.5 h-3.5',
        text: 'text-white font-semibold',
        solanaSize: { width: 10, height: 8 },
        arrowIcon: 'w-3 h-3',
    },
    statusBar: {
        ...
        walletIcon: 'w-[10px] h-[10px] text-[#6b6b7a]',
        text: 'text-[#e2e8f0] font-semibold',
        solanaSize: { width: 10, height: 8 },
        arrowIcon: 'w-[10px] h-[10px] text-[#fcfcfcfc]',
    },
};
